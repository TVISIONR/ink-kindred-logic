      ...
      <section className="mx-auto max-w-7xl px-5 pt-16 pb-20">
        ...
        <div className="mt-14 grid gap-10 md:grid-cols-[2fr_1fr]">
              ...
              <div className="space-y-5">
                ...
                <Field label="How many cards do you need?">
                  <select className={inputCls} defaultValue="">
                    ...
                    <option>30–99 cards</option>
                    <option>100–299 cards</option>
                    <option>300–999 cards</option>
          ...
          <div className="space-y-6">
            <ContactCard icon={Mail} title="Email" value="hello@ritershub.in" />
            <ContactCard icon={Phone} title="Phone" value="+91 90000 00000" />
            <ContactCard icon={MapPin} title="Studio" value="Panjim, Goa, India" />
          </div>
        </div>
      </section>
    </SiteLayout>
